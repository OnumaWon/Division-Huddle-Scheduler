...
export const GENERAL_MANAGERS: Employee[] = [
  { name: "แสงระวี ศรีงาม", position: "Imaging Manager", department: "Imaging" },
  { name: "ลัดดา ทวีศักดิ์", position: "Senior Nurse Manager", department: "Nursing Staff Organization" },
  { name: "ภรณี พวงจิต", position: "Medical Affairs Office Manager", department: "Medical Affairs Office" },
  ...
  { name: "นาฏกมล จารัสกาญจน์", position: "Patient Experience Manager", department: "Customer Experience Management" },
  { name: "ชวาลินทร์ มนต์อุ่น", position: "Special Project Management Mgr", department: "Administration Office" },
  { name: "จุฬารัตน์ พรหมน้อย", position: "IPD Manager", department: "In Patient Division" },
  { name: "นิยมพงษ์ ต่วงดี", position: "Corporate Communication & Branding Manager", department: "Corporate Communication & Branding" },
  ...
  { name: "ศรีสุดา จิตต์วัชรินทร์", position: "Deputy Account & Finance Mgr.", department: "Accounting and Finance" },
  ...
  { name: "อรอุมา วงษ์พานิช", position: "Deputy Manager", department: "Nursing Staff Organization" },
  { name: "สุพรรณิการ์ พูนธนานิวัฒนกุล", position: "Quality Center Manager", department: "Quality Center" },
  { name: "ปฏิพัทธ์ ประเสริฐวิทยากิจ", position: "General Support Division Mgr.", department: "General Support Division" },
  ...
  { name: "ดรุณี จิตวรินทร์", position: "Deputy Data Management Mgr.", department: "Accounting and Finance" },
  { name: "จตุพร ระเด่น", position: "HRM Manager", department: "Human Resources Management" },
  { name: "ฐิตาภรณ์ ปิยะพลีษฐ์", position: "Logistic and Inventory Manager", department: "Inventory" }
];

// Managers (Lead Team) - Priority Last (Image 4)
export const LAST_PRIORITY_MANAGERS: Employee[] = [
  ...
  { name: "กาญจนา พันธุ์ไชยศรี", position: "Deputy Manager", department: "Hospital Informatic" },
...
// HODs (Co-lead Team) - Priority First (Image 3)
export const PRIORITY_HODS: Employee[] = [
  ...
  { name: "กัญช์ เกสรสกุนธ์", position: "Mental Health Clinic HOD", department: "Mental Health Clinic" },
  ...
  { name: "พงศ์วรัท แซ่เจี๊ย", position: "Customer Services HOD", department: "Customer Services" },
  { name: "สีนินาฏ จำรัสกาญจน์", position: "IPD Pharmacy HOD", department: "IPD Pharmacy" },
  ...
  { name: "ชลธิรา ลาดเวร", position: "Ward 7A HOD", department: "Ward 7A" },
  ...
  { name: "ไอลดา บุญโยดม", position: "Overseas Marketing HOD", department: "Overseas Marketing" },
...
// HODs (Co-lead Team) - General Pool (Image 2)
export const GENERAL_HODS: Employee[] = [
  { name: "พุทธชาด วรธรรมารมณ์", position: "Outreach Clinic HOD", department: "Outreach Clinic" },
  ...
  { name: "เสาวลักษณ์ อุทัยกุล", position: "Ward 5B HOD", department: "Ward 5B" },
  ...
  { name: "จุไรรัตน์ พลหาญ", position: "OB & GYN HOD", department: "Obstetrics & Gynecology" },
  ...
  { name: "วิริชา เสริมสุข", position: "Nursery & LR HOD", department: "Nursery" },
  { name: "กนกพร บุญรอด", position: "Medical Record HOD", department: "Medical Record" },
  { name: "จุฬาลักษณ์ ติวานุสรณ์", position: "Sales Referral HOD", department: "Referral Marketing" },
  ...
  { name: "พรชนา ทองตัน", position: "Price Estimation&Admission HOD", department: "Admission" },
  { name: "รวิพรรณ คชวงศ์", position: "Ward 7B HOD", department: "Ward 7B" },
  { name: "ภวิตา วิภวกานต์", position: "Pediatrics HOD", department: "Pediatrics" },
  { name: "กัลยาณี เคทอง", position: "Eye & Bright View HOD", department: "Eye Center" },
  { name: "เอกศิษย์ หนูนาม", position: "Patient Escort HOD", department: "Patient Escort" },
  { name: "พัทรจา เจียสกุล", position: "BDMS Wellness Clinic Phuket HOD", department: "Health Promotion" },
  ...
  { name: "ชญาดา นิรันดรายกุล", position: "Ward 3B HOD", department: "Ward 3B" },
  { name: "พิมลพรรณ เกษมูล", position: "Ward 8A HOD", department: "Ward 8A" },
  ...
  { name: "กรรณิกา แซ่ลี้", position: "Accounting HOD", department: "Accounting" },
  { name: "สุชีวะ แสวงมี", position: "Anesthetic HOD", department: "Anesthetic" },
  { name: "สุภาพร ค่ายทองอินทร์", position: "Dispatch Center HOD", department: "Dispatch Center" }
];
